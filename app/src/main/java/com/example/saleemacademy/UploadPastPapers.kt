...
class UploadPastPapers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.uploadpastpapers)
    ...
    private fun retrieveFilesFromFirebaseStorage() {
        val storageRef = storage.reference.child("PastPapers")
    ...
    private fun deleteFileFromFirebaseStorage(fileName: String) {
        val storageRef = storage.reference.child("PastPapers").child(fileName)
    ...
    private fun uploadFileToFirebaseStorage() {
        ...
        val fileRef = storageRef.child("PastPapers/$selectedFileTitle.pdf")
